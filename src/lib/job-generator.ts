...
const DEFAULT_QUERY = "Bodenleger";
...
const PROJECT_TYPES = [
  ...
  "Gewerbeobjekten",
  "Industrieanlagen",
  "Renovationsprojekten",
  "Hotelprojekten",
  "Ladenbau-Projekten",
];

const RESPONSIBILITY_TEMPLATES = [
  "Verlegen von Bodenbelägen wie Parkett, Laminat, Vinyl und Teppich.",
  "Verfugen und Versiegeln von Fliesen- und Plattenbelägen.",
  "Schleifen, Ölen und Versiegeln von Holz- und Parkettböden.",
  "Vorbereitung und Nivellierung von Untergründen und Estrichen.",
  "Montage von Sockelleisten, Übergangsprofilen und Abschlüssen.",
  "Dokumentation der ausgeführten Bodenarbeiten und Materialmengen.",
  "Zusammenarbeit mit Bauleitung, Polieren und anderen Gewerken.",
  "Einhaltung von Qualitäts- und Terminvorgaben auf der Baustelle.",
  "Durchführung von Reparaturen und Unterhaltsarbeiten an Böden.",
  "Begleitung von Abnahmen und Übergaben mit dem Kunden.",
  "Verlegung von Industrieböden und Epoxidharz-Beschichtungen.",
  "Mitarbeit bei Materialdisposition und Auftragsplanung.",
];

const REQUIREMENT_TEMPLATES = [
  "Abgeschlossene Ausbildung im Bodenbelagsbereich (EFZ oder gleichwertig).",
  "Sorgfältige und selbstständige Arbeitsweise.",
  "Teamfähigkeit und klare Kommunikation auf Deutsch.",
  "Erfahrung in Neu- und Renovationsprojekten von Vorteil.",
  "Sicherer Umgang mit Verlegeplänen und Masszeichnungen.",
  "Fahrausweis Kategorie B oder Bereitschaft dazu.",
  "Zuverlässigkeit und hohes Qualitätsbewusstsein.",
  "Freude an direktem Kundenkontakt und sorgfältiger Handwerksarbeit.",
  "Kenntnisse der gängigen Verlegetechniken und Klebstoffe.",
  "Bereitschaft zur fachlichen Weiterbildung.",
  "Lösungsorientiertes Denken auch unter Zeitdruck.",
  "Sauberes und professionelles Auftreten auf der Baustelle.",
];
...
const BENEFIT_TEMPLATES = [
  ...
  "Attraktive Zulagen für Spezialaufträge und Grossobjekte.",
...
function buildGeneratedJob(
  ...
  const focusText = primaryFocus
    ...
    : "mit Fokus auf moderne Bodenprojekte";
