...
export const BODEN_CITIES: BodenCity[] = [
  {
    slug: "zuerich",
    name: "Zürich",
    cantonAbbr: "ZH",
...
export function findBodenCity(slug: string): BodenCity | null {
  return BODEN_CITIES.find((city) => city.slug === slug) ?? null;
}
