...
import { getEditorialContent } from "@/data/editorial/bodenlegerjob";
...
export async function generateMetadata({ params }: LandingPageProps): Promise<Metadata> {
  ...
  if (!config) {
    return {
      title: "Bodenlegerjobs",
      description: "Aktuelle Bodenlegerjobs in der Schweiz.",
    };
  }
  ...
  return {
    ...
    openGraph: {
      title: `${config.title} | bodenlegerjob.ch`,
      description: config.description,
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-5xl">
        ...
        {editorial && (
          <EditorialIntro role={config.role} canton={config.canton} content={editorial} />
        )}
