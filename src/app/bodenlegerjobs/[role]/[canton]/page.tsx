...
export async function generateMetadata({ params }: LandingPageProps): Promise<Metadata> {
  ...
  if (!config) {
    return {
      title: "Bodenbelagjobs",
      description: "Aktuelle Bodenbelagjobs in der Schweiz.",
    };
  }
  ...
  return {
    ...
    // Only six editorial priorities may become indexable, and only while at
    // least three matching real vacancies are available.
