...
const HOMEPAGE_FAQS = [
  {
    ...
    answer:
      "Eine Karte mit der Kennzeichnung Direktanstellung ist kein konkretes Stelleninserat. Das Team sucht fortlaufend einen passenden Arbeitgeber für das angezeigte Bodenbelagprofil und die gewählten Präferenzen. Ein Arbeitsvertrag kommt ausschliesslich direkt zwischen Fachkraft und diesem Arbeitgeber zustande. Arbeitgeber, Lohn, Starttermin und Verfügbarkeit werden erst nach einer konkreten Abklärung genannt.",
  },
  {
    question: "Welche Stellen finde ich auf bodenlegerjob.ch?",
    answer:
      "Die Suche bündelt öffentlich zugängliche Stelleninserate mit klarem Bezug zum Bodenbelaggewerk. Dazu können Stellen für Boden-Parkettlegerinnen und Boden-Parkettleger, Parkett- und Plattenleger, Industrieboden-Fachkräfte sowie Vorarbeiter und Projektleiter gehören. Welche Treffer vorhanden sind, zeigt die aktuelle Ergebnisliste; bodenlegerjob.ch verspricht weder eine vollständige Abdeckung des Schweizer Arbeitsmarkts noch eine bestimmte Zahl an Inseraten.",
  },
  {
    question: "Wie suche ich nach einem Bodenbelagjob?",
    answer:
      "Gib eine Berufsbezeichnung oder ein Bodenbelag-Stichwort und bei Bedarf einen Ort ein. Die Ergebnisliste lässt sich mit den angebotenen Filtern weiter eingrenzen. Massgebend für Aufgaben, Qualifikation, Pensum, Arbeitsort und Lohn sind die Angaben im jeweiligen Inserat. Fehlt eine Angabe, ergänzt bodenlegerjob.ch dafür keine pauschale Schätzung.",
  },
  {
    question: "Wie lange dauert die Lehre als Boden-Parkettleger/in EFZ?",
    answer:
      "Das offizielle Berufsprofil von berufsberatung.ch nennt für die berufliche Grundbildung Boden-Parkettleger/in EFZ eine Dauer von drei Jahren und den Abschluss mit eidgenössischem Fähigkeitszeugnis. Die obligatorische Schule muss abgeschlossen sein. Details zu Ausbildung, Aufgaben und Weiterbildung stehen im verlinkten Berufsprofil.",
  },
  {
    question: "Wie kann ich einen Lohn für eine Bodenbelagstelle vergleichen?",
    answer:
...
export function HomepageSeoContent() {
  return (
    <section className="editorial-surface" aria-label="Informationen für Bodenbelag-Fachkräfte">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-14 sm:py-20 max-w-6xl">
        ...
        <div className="self-start">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-foreground mb-5">
            Bodenbelagjobs in der Schweiz suchen
          </h2>
          <p className="text-slate-600 text-base sm:text-lg leading-relaxed mb-4">
            bodenlegerjob.ch bündelt Stelleninserate mit klarem Bezug zum
            Bodenbelaggewerk. Suche nach Beruf und Ort und prüfe auf der Detailseite
          ...
          <div className="mt-6 border-l-4 border-primary/45 pl-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-600">
              Sind weniger als zwölf konkrete Inserate vorhanden, ergänzen kontrollierte Bodenbelagprofile die Ansicht. Sie sind keine offenen Stellen: Das Team nimmt die gewählten Berufs- und Ortspräferenzen auf, sucht fortlaufend einen passenden Arbeitgeber und stellt den Kontakt erst nach einer konkreten Abklärung her. Die Anstellung erfolgt direkt bei diesem Arbeitgeber.
            </p>
          </div>
        </div>
        ...
        <div className="source-panel p-6 sm:p-8">
          ...
          <ul className="space-y-2 text-sm">
            <li>
              ...
              >
                berufsberatung.ch: Boden-Parkettleger/in EFZ
              </a>
            </li>
            <li>
              <a
        ...
        <div className="mb-8 border-t border-border pt-10">
          ...
          <h2 className="text-2xl sm:text-3xl font-black text-foreground mb-3">
            Bodenbelagstellen nach Beruf und Kanton
          </h2>
