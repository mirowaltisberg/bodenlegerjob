...
import type { EditorialContent } from "@/data/editorial/bodenlegerjob";
import { EDITORIAL_BYLINE } from "@/data/editorial/bodenlegerjob";

interface EditorialIntroProps {
  /** Display label for the role, e.g. "Bodenleger EFZ" */
  role: string;
