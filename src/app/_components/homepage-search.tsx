      ...
      <header className="border-b header-blur sticky top-0 z-30 animate-header">
        <div className="container mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between gap-2">
          <Link href="/" className="flex items-center shrink-0" onClick={resetToHome}>
            <Image src="/logo.svg" alt="bodenlegerjob.ch — Bodenlegerjobs in der Schweiz" width={142} height={29} className="h-7 sm:h-8 w-auto" priority />
          </Link>
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 text-center">
            <h1 className="animate-hero-title text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 mb-4 sm:mb-6 tracking-tight leading-tight">
              <span className="text-primary">Bodenleger Jobs</span> Schweiz
              <span className="block text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-700 mt-2 sm:mt-4">246 offene Stellen</span>
            </h1>
            <p className="animate-hero-subtitle text-base sm:text-lg text-slate-600 mb-8 sm:mb-10 max-w-2xl mx-auto px-1">
              Live-Stellen mit smarter Filterung für Bodenleger-Fachkräfte in der ganzen Schweiz. Finde den perfekten Job (Vollzeit / Teilzeit Pensum).
            </p>
            ...
            <AnimateOnScroll className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4">
              <div>
                <h2 className="text-xl sm:text-2xl font-bold text-slate-900">
                  {hasSearched ? "Suchergebnisse" : "Aktuelle Bodenlegerjobs (Vollzeit/Teilzeit Pensum)"}
                </h2>
                {hasActiveLocation && (
                          ...
                          <CardContent className="p-4 sm:p-6">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3">
                              ...
                              <div className="flex items-center gap-3 shrink-0">
                                ...
                                >
                                  <Layers className="h-3 w-3 mr-1 fill-current" />
                                  Bewerben
                                </Badge>
