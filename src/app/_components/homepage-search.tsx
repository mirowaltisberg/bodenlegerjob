        ...
        >
          <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 mb-5">
              <div>
                ...
                <h2 className="text-2xl sm:text-3xl font-black text-foreground">
                  {hasSearched ? "Passende Bodenbelagstellen" : "Aktuelle Bodenbelagstellen"}
                </h2>
                {hasActiveLocation && (
            ...
            {opportunities.length > 0 && (
              <div className="source-panel mb-4 px-4 py-3 text-sm text-foreground" role="status" aria-live="polite">
                <p className="font-semibold">
                  {totalJobs} konkrete {totalJobs === 1 ? "Stelle" : "Stellen"} und {opportunities.length} Direktanstellungsprofile
                </p>
            ...
            {!isLoading && !errorMessage && (
              <DirectHireOpportunityFeed opportunities={opportunities} />
            )}
