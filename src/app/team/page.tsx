...
export const metadata: Metadata = {
  ...
  description:
    "Quellen, Methodik und Grenzen der redaktionellen Inhalte auf bodenlegerjob.ch.",
  alternates: {
    canonical: "/team",
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main id="main-content" className="flex-1 container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-3xl">
        ...
        <p className="text-slate-600 mt-3 text-base sm:text-lg leading-relaxed">
          bodenlegerjob.ch ergänzt die Stellensuche mit kurzen Informationen zum
          Bodenbelagberuf, zur Ausbildung und zur Einordnung von Lohnangaben.
        </p>
        ...
        <section className="mt-10 space-y-6">
          <article>
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              ...
              Bodenbelaggewerk. Pauschale Aussagen über regionale Nachfrage,
          ...
          <article>
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              ...
              <a
                href="https://www.bodenschweiz.ch/"
                target="_blank"
                rel="noopener noreferrer"
                className="underline hover:text-primary"
              >
