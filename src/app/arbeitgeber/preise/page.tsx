...
export const metadata: Metadata = {
  title: "Preise & Pakete",
  description:
    "Erfahren Sie mehr über die Inseratepreise und Pakete auf bodenlegerjob.ch — der spezialisierten Jobbörse für Bodenleger-Fachkräfte.",
};
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 py-12 sm:py-16 max-w-3xl">
        ...
        <p className="text-slate-600 mb-8 leading-relaxed">
          Publizieren Sie Ihre offenen Stellen auf bodenlegerjob.ch — der
          spezialisierten Jobbörse für Bodenleger-Fachkräfte in der Schweiz. Wir
        ...
        <div className="text-center">
          ...
          <Button asChild size="lg">
            <a href="mailto:info@bodenlegerjob.ch">info@bodenlegerjob.ch kontaktieren</a>
          </Button>
        </div>
