...
import { BODEN_CITIES } from "@/lib/bodenleger-cities";

export const metadata: Metadata = {
  title: "Bodenleger in der Nähe | Jobs in deiner Stadt finden",
  description:
    "Bodenbelagstellen nach ausgewählten Schweizer Städten und Regionen durchsuchen.",
  alternates: { canonical: "/bodenleger-in-der-naehe" },
  openGraph: {
    title: "Bodenleger in der Nähe | Jobs in deiner Stadt finden",
    description: "Bodenbelagstellen nach ausgewählten Schweizer Städten und Regionen durchsuchen.",
    url: "/bodenleger-in-der-naehe",
    type: "website",
  },
  twitter: {
