"""Scrape a fresh chunk of genuine Swiss flooring jobs into JSON.
...
from job_safety import CONFIG as JOB_SAFETY_CONFIG, classify_boden_title
...
def is_relevant_job(job: dict) -> bool:
    """Return True only for clearly flooring-related Swiss roles."""
    ...
    return classify_boden_title(title)["disposition"] == "ACCEPT"
...
DEFAULT_SEARCH_TERMS = [
    ...
    "Arbeitsvorbereitung Bodenbeläge",
]
...
def main():
    parser = argparse.ArgumentParser(description="Scrape Swiss flooring jobs")
