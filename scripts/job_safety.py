"""Shared deny-first Bodenbelag classifier backed by src/config/job-safety.json."""
...
def classify_boden_title(title_value: Any) -> dict[str, Any]:
    ...
    if not match:
        return {"disposition": "REJECT", "reason": "no-boden-title-signal"}
    ...
    return {
        "disposition": "ACCEPT",
        "reason": "specific-boden-title" if specific else "broad-role-with-boden-context",
